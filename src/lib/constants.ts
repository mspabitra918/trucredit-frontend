export const SITE_NAME = "TruCredit";
export const SITE_URL = "https://www.trucredit.com";
export const SITE_DESCRIPTION =
  "TruCredit is a direct personal loan provider offering competitive rates for debt consolidation, home improvement, medical expenses, and more. Apply online in minutes.";
export const BUSINESS_EMAIL = "leads@trucredit.com";
